          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-6">
                ...
                <input type="date" class="form-control"
                       id="addname" name="start" value="${donation.startDate}" readonly="readonly">
              </div>
              <div class="col-6">
                <label for="addcost"
                       class="col-form-label">Ngày kết thúc:</label>
                <input type="date" class="form-control"
                       id="addcost" name="end" value="${donation.endDate}"readonly="readonly">
              </div>
            </div>
            <div class="row">
              <div class="col-6">
             ...
             <c:choose>
                <c:when test="${donation.status == 1}"><input type="text" class="form-control"
                       id="addcost" name="end" value="Mới tạo" readonly="readonly"></c:when>
                <c:when test="${donation.status == 2}"><input type="text" class="form-control"
                       id="addcost" name="end" value="Đang quyên góp" readonly="readonly"></c:when>
                <c:when test="${donation.status == 3}">                <input type="text" class="form-control"
                       id="addcost" name="end" value="Kết thúc quyên góp" readonly="readonly"></c:when>
                <c:when test="${donation.status == 4}">                <input type="text" class="form-control"
                       id="addcost" name="end" value="Đóng quyên góp" readonly="readonly"></c:when>
            </c:choose>
            ...
            <div class="row">
              <div class="col-6">
                ...
                <input type="text" class="form-control"
                       id="addname" name="tochuc" value="${donation.organizationName}" readonly="readonly">
              </div>
              <div class="col-6">
                <label for="addcost"
                       class="col-form-label">Số điện thoại:</label>
                <input type="number" class="form-control"
                       id="addcost" name="sdt" value="${donation.phoneNumber}" readonly="readonly">
              </div>
              <div class="col-12">
                <label for="ct_id" class="col-form-label">Nội dung:</label>
                <textarea name="noidung" class="form-control" cols="50" value="${donation.description}" readonly="readonly"></textarea>
              </div>
            </div>
            <!--Detail-->
      ...
      <td style="display: flex;justify-content: space-between">
           <c:choose>
                <c:when test="${userDonation.status == 0}">
                    <form action="<c:url value='/user/confirmDonation'/>" method="post" style="margin-right: 5px;">
                        <input type="hidden" class="form-control" id="id" name="idD"
