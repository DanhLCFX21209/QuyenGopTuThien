      ...
      <div class="row align-items-center">
        ...
        <nav class="mx-auto site-navigation">
          <ul class="site-menu js-clone-nav d-none d-xl-block ml-0 pl-0">
            <li th:if="${session.user}" class="d-lg-none"><a href="post-job"><span class="mr-2" th:text="${session.user.fullName}"></span> </a></li>
            ...
            <ul class="comment-list">
                ...
                <li class="comment">
                  ...
                  <div class="comment-body">
                    <h3>${userDonation.name}</h3>
                    <div class="meta" style="color: #373b3e !important;">${userDonation.created}</div>
                    <p>${userDonation.monney}</p>
                  </div>
                </li>
        ...
        <div class="col-lg-6">
          <div class="bg-light p-3 border rounded mb-4">
            ...
            <ul class="list-unstyled pl-3 mb-0">
              <li class="mb-2"><strong class="text-black">Mã đợt quyên góp: ${donation.code}</strong> </li>
              <li class="mb-2"><strong class="text-black">Tên đợt quyên góp: ${donation.name}</strong></li>
              <li class="mb-2"><strong class="text-black">Ngày bắt đầu: ${donation.startDate}</strong> </li>
              <li class="mb-2"><strong class="text-black">Ngày kết thúc: ${donation.endDate}</strong> </li>
              <li class="mb-2"><strong class="text-black">Cá nhân/Tổ chức: ${donation.organizationName}</strong></li>
              <li class="mb-2"><strong class="text-black">Số điện thoại: ${donation.phoneNumber}</strong></li>
              <li class="mb-2"><strong class="text-black">Tổng tiền quyên góp nhận được: ${donation.money}</strong></li>
              <li class="mb-2"><strong class="text-black">Trạng thái: </strong>
              	              <c:choose>
                <c:when test="${donation.status == 1}">Mới tạo</c:when>
                <c:when test="${donation.status == 2}">Đang quyên góp</c:when>
                <c:when test="${donation.status == 3}">Kết thúc quyên góp</c:when>
                <c:when test="${donation.status == 4}">Đóng đợt quyên góp</c:when>
            </c:choose>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Quyên góp: ${donation.name}</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <form method="post" action="<c:url value='/user/saveUserDonation'/>">
              ...
              <div class="row">
                ...
                <div class="col-12">
                  ...
                  <input type="text" class="form-control"
                         id="addname" name="name" placeholder="" value="${userDonation.name}" required>
                  <label for="addname"
                         class="col-form-label">Số tiền quyên góp:</label>
                  <input type="number" class="form-control" placeholder=""
                         id="addname" name="monney" value="${userDonation.monney}" required>
                  <input type="hidden" class="form-control" placeholder=""
                         id="addname" name="idUser" >
                  <input type="hidden" class="form-control" placeholder=""
                         id="addname" name="idDonation" value="${donation.id}" required>
