                    ...
                    <li style="margin-bottom: 20px" class="job-listing d-block d-sm-flex pb-3 pb-sm-0 align-items-center ">
                        <div class="job-listing-about d-sm-flex custom-width w-100 justify-content-between mx-4">
                     		...
                     		<div class="job-listing-position custom-width mb-3 mb-sm-0" style="padding: 10px;width: 250px">
                     		  <a href="<c:url value='/user/detail2/' />${donation.id}">
                                <h2>${donation.name}</h2>
                                <strong>
           	<c:choose>
                ...
                <c:when test="${donation.status == 4}">Đóng đợt quyên góp</c:when>
                            ...
                            <div class="job-listing-meta custom-width w-20" style="z-index: 1000;" >
                            	  <c:if test="${donation.status == 2}">
                            	
                                <p style="margin-top: 20px" class="btn btn-primary py-2" data-toggle="modal" data-target="#donationModal-${donation.id}">Quyên góp</p>
                             </c:if>
                    ...
                    <!-- Modal -->
                    <div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" id="donationModal-${donation.id}">
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                <input type="text" class="form-control" id="addname" name="name" placeholder="" value="${userDonation.name}" required>
                                                <label for="addname" class="col-form-label">Số tiền quyên góp:</label>
                                                <input type="number" class="form-control" placeholder="" id="addname" name="monney" value="${userDonation.monney}" required>
                                                <input type="hidden" class="form-control" placeholder="" id="addname" name="idUser">
                                                <input type="hidden" class="form-control" placeholder="" id="addname" name="idDonation" value="${donation.id}" required>
                ...
                <script>
                    ...
                    function showPage(page) {
                        ...
                        var selectedPage = document.getElementsByClassName("page-" + page);
                        if (selectedPage.length > 0) {
                            selectedPage[0].style.display = "block";
                        }
                    }
                </script>
            </ul>
