...
Chức năng 1: Quản lý người dùng (dành cho Admin)

1. Hiển thị ra danh sách của người dùng
...
3. Tìm kiếm thông tin người dùng qua số điện thoại hoặc email
...
4. Cho phép/không cho phép một người dùng sử dụng hệ thống
...
Chức năng 2: Quản lý đợt quyên góp (dành cho Admin)

1. Hiển thị ra danh sách của đợt quyên góp
...
3. Tìm kiếm một đợt quyên góp dựa vào trạng thái của đợt quyên góp: mới tạo, đang quyên góp, kết thúc quyên góp và đóng quyên góp
...
4. Tìm kiếm một đợt quyên góp dựa vào số điện thoại cá nhân, tên tổ chức và mã số của đợt quyên góp
...
5. Xóa một đợt quyên góp ở trạng thái ‘mới tạo’
...
6. Cập nhật thông tin của một đợt quyên góp khi chưa ở trạng thái ‘đóng quyên góp’
...
7. Xem chi tiết thông tin của đợt quyên góp
...
8. Thay đổi trạng thái của một đợt quyên góp
...
1. Hiển thị danh sách của các đợt quyên góp
...
2. Xem chi tiết thông tin của một đợt quyên góp
...
3. Thực hiện quyên góp nhanh mà không cần xem chi tiết thông tin đợt quyên góp
...
.Yêu cầu chức năng nâng cao

1. Xác nhận/hủy xác nhận với việc nhận được tiền từ nhà quyên góp theo cách làm thủ công (dành cho người quản lý hệ thống)
...
2.Thực hiện quyên góp khi xem thông chi tiết của một đợt quyên góp (dành cho người dùng hệ thống)
